...
const EXPECTED_GROUPS = {
  rust: [
    ...
    'tests/**',
    'docs/api/fixtures/**',
    'docs/api/provider-interface-definitions.md',
    'docs/api/format-field-coverage-matrix.md',
    'docs/api/format-conversion-audit.md',
...
test('matcher classifies representative paths exactly like the CI filters', () => {
  ...
  const cases = [
    ...
    [['docs/api/format-field-coverage-matrix.md'], ['rust']],
    [['docs/api/format-conversion-audit.md'], ['rust']],
