...
ALTER TABLE public.request_fund_reservations ADD COLUMN usage_policy jsonb;
...
ALTER TABLE public.usage_cost_reservations ADD COLUMN attempt_reservation_token varchar(128);
...
ALTER TABLE public.usage_cost_reservations ADD CONSTRAINT usage_cost_reservations_attempt_token_fkey
    ...
    ON DELETE RESTRICT;
CREATE UNIQUE INDEX usage_cost_reservations_attempt_token_idx
