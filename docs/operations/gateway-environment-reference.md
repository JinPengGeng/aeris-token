...
| `AETHER_GATEWAY_USAGE_QUEUE_DLQ_RETENTION_SECS` | gateway root/server; not inherited by subcommands | `1209600` (14 天) | `u64` | [main.rs](../../apps/aether-gateway/src/main.rs) |
