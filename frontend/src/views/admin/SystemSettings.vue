      ...
      <div class="flex-1 min-w-0">
        ...
        >
          ...
          <BasicConfigSection
            ...
            :referral-require-first-recharge="systemConfig.referral_require_first_recharge"
            :referral-lifetime-reward-cap-usd="systemConfig.referral_lifetime_reward_cap_usd"
            ...
            @update:referral-require-first-recharge="systemConfig.referral_require_first_recharge = $event"
            @update:referral-lifetime-reward-cap-usd="systemConfig.referral_lifetime_reward_cap_usd = $event"
