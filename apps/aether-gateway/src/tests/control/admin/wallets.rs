...
async fn gateway_handles_admin_wallets_adjust_locally_with_trusted_admin_principal() {
    ...
    assert_eq!(payload["wallet"]["balance"], json!("19.00000000"));
    assert_eq!(payload["wallet"]["recharge_balance"], json!("16.50000000"));
    assert_eq!(payload["wallet"]["total_adjusted"], json!("5.50000000"));
    assert_eq!(payload["transaction"]["category"], "adjust");
    assert_eq!(payload["transaction"]["reason_code"], "adjust_admin");
    assert_eq!(payload["transaction"]["amount"], json!("4.00000000"));
    assert_eq!(
        payload["transaction"]["balance_before"],
        json!("15.00000000")
    );
    assert_eq!(
        payload["transaction"]["balance_after"],
        json!("19.00000000")
    );
    assert_eq!(*upstream_hits.lock().expect("mutex should lock"), 0);
...
async fn gateway_handles_admin_wallets_recharge_locally_with_trusted_admin_principal() {
    ...
    assert_eq!(payload["wallet"]["balance"], json!("23.00000000"));
    assert_eq!(payload["wallet"]["recharge_balance"], json!("20.50000000"));
    assert_eq!(payload["wallet"]["total_recharged"], json!("38.00000000"));
...
async fn gateway_handles_admin_wallets_process_refund_locally_with_trusted_admin_principal() {
    ...
    assert_eq!(payload["wallet"]["balance"], json!("11.00000000"));
    assert_eq!(payload["wallet"]["recharge_balance"], json!("8.50000000"));
    assert_eq!(payload["wallet"]["total_refunded"], json!("7.00000000"));
...
async fn gateway_releases_offline_processing_refund_without_gateway_evidence() {
    ...
    assert_eq!(response.status(), StatusCode::OK);
    let payload: serde_json::Value = response.json().await.expect("json body should parse");
    assert_eq!(payload["wallet"]["balance"], json!("15.00000000"));
    assert_eq!(payload["wallet"]["recharge_balance"], json!("12.50000000"));
    assert_eq!(payload["wallet"]["total_refunded"], json!("3.00000000"));
